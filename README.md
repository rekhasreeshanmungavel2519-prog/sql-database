# sql-database
A simple SQL project demonstrating table creation, data insertion,  aggregate functions, grouping, filtering, and updates using a Students database.
Overview
...
Calculate total scores and identify top scorer
Count students by grade
Average total score by gender
Filter students based on Math score
...
Open your SQL database (MySQL, PostgreSQL, or DB Fiddle).
Run students_analysis.sql step by step.
Observe results and modify data if needed for practice.
Author
Yukesh
